...
export function ContentPolicies({ config, onUpdate }: ContentPoliciesProps) {
  const handlePolicyChange = (key: keyof Config['contentPolicies'], value: boolean) => {
    onUpdate({
      contentPolicies: {
    ...
    <Stack gap="xl">
      <Card shadow="sm" padding="lg" radius="md" withBorder>
        ...
        <Text size="sm" c="dimmed" mb="lg">
          Select which content types should be prioritized for caching and sharing with nearby
          peers. This helps reduce server load and improve performance for popular content.
        </Text>
      ...
      <Card shadow="sm" padding="lg" radius="md" withBorder>
        ...
        <Text size="sm" c="dimmed" mb="md">
          Choose up to two attributes to prioritize when selecting peers. These guide the system
          towards peers with your preferred characteristics.
        </Text>
